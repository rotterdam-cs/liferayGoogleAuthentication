...
<%@page import="com.liferay.portal.util.GooglePropsKeys"%>
...
boolean googleConnectAuthEnabled = GoogleConnectUtil.isEnabled(company.getCompanyId());
boolean googleConnectVerifiedAccountRequired = GoogleConnectUtil.isVerifiedAccountRequired(company.getCompanyId());
String googleConnectAppId = GoogleConnectUtil.getAppId(company.getCompanyId());
String googleConnectAppSecret = GoogleConnectUtil.getAppSecret(company.getCompanyId());
String googleConnectGraphURL = GoogleConnectUtil.getGraphURL(company.getCompanyId());
String googleConnectOauthAuthURL = GoogleConnectUtil.getAuthURL(company.getCompanyId());
String googleConnectOauthTokenURL = GoogleConnectUtil.getAccessTokenURL(company.getCompanyId());
String googleConnectRedirectURL = GoogleConnectUtil.getRedirectURL(company.getCompanyId());
...
<liferay-ui:tabs
	names="general,ldap,cas,facebook,Google,ntlm,open-id,open-sso,siteminder"
	refresh="<%= false %>"
>
	<liferay-ui:section>
		<aui:fieldset>
	...
	<liferay-ui:section>
		<aui:fieldset>
			<aui:input inlineLabel="left" label="enabled" name='<%= "settings--" + GooglePropsKeys.GOOGLE_CONNECT_AUTH_ENABLED + "--" %>' type="checkbox" value="<%= googleConnectAuthEnabled %>" />

			<aui:input inlineLabel="left" label="verified-account-required" name='<%= "settings--" + GooglePropsKeys.GOOGLE_CONNECT_VERIFIED_ACCOUNT_REQUIRED + "--" %>' type="checkbox" value="<%= googleConnectVerifiedAccountRequired %>" />

			<aui:input cssClass="lfr-input-text-container" label="application-id" name='<%= "settings--" + GooglePropsKeys.GOOGLE_CONNECT_APP_ID + "--" %>' type="text" value="<%= googleConnectAppId %>" />

			<aui:input cssClass="lfr-input-text-container" label="application-secret" name='<%= "settings--" + GooglePropsKeys.GOOGLE_CONNECT_APP_SECRET + "--" %>' type="text" value="<%= googleConnectAppSecret %>" />

			<aui:input cssClass="lfr-input-text-container" label="graph-url" name='<%= "settings--" + GooglePropsKeys.GOOGLE_CONNECT_GRAPH_URL + "--" %>' type="text" value="<%= googleConnectGraphURL %>" />

			<aui:input cssClass="lfr-input-text-container" label="oauth-authentication-url" name='<%= "settings--" + GooglePropsKeys.GOOGLE_CONNECT_OAUTH_AUTH_URL + "--" %>' type="text" value="<%= googleConnectOauthAuthURL %>" />

			<aui:input cssClass="lfr-input-text-container" label="oauth-token-url" name='<%= "settings--" + GooglePropsKeys.GOOGLE_CONNECT_OAUTH_TOKEN_URL + "--" %>' type="text" value="<%= googleConnectOauthTokenURL %>" />

			<aui:input cssClass="lfr-input-text-container" label="redirect-url" name='<%= "settings--" + GooglePropsKeys.GOOGLE_CONNECT_OAUTH_REDIRECT_URL + "--" %>' type="text" value="<%= googleConnectRedirectURL %>" />
		</aui:fieldset>
	</liferay-ui:section>
	<liferay-ui:section>
		<aui:fieldset>
