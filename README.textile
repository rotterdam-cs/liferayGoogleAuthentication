...
h5. Setup/Configure
	...
	- cmd to \liferayGoogleAuthentication\google-sso
		-	Execute mvn clean install package liferaydeploy

	- cmd to \liferayGoogleAuthentication\google-login-hook
		-	Execute mvn clean package liferaydeploy
